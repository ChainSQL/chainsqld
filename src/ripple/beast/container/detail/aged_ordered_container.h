...
private:
    ...
    class pair_value_compare
        : public beast::detail::empty_base_optimization2 <Compare>
    ...
    public:
        ...
        pair_value_compare (pair_value_compare const& other)
            : beast::detail::empty_base_optimization2 <Compare> (other)
        {
        }
    ...
    private:
        ...
        pair_value_compare (Compare const& compare)
            : beast::detail::empty_base_optimization2 <Compare> (compare)
        {
        }
    };
    ...
    public:
        ...
        Compare& compare()
        {
            return beast::detail::empty_base_optimization2 <Compare>::member();
        }
    ...
    class config_t
        ...
        , public beast::detail::empty_base_optimization2 <ElementAllocator>
    {
    public:
        explicit config_t (
            clock_type& clock_)
        ...
        config_t (
            ...
            : beast::detail::empty_base_optimization2 <ElementAllocator> (alloc_)
            , clock (clock_)
        {
        }
        ...
        config_t (config_t const& other)
            ...
            , beast::detail::empty_base_optimization2 <ElementAllocator> (
        ...
        config_t (config_t const& other, Allocator const& alloc)
            : KeyValueCompare (other.key_compare())
            , beast::detail::empty_base_optimization2 <ElementAllocator> (alloc)
            , clock (other.clock)
        {
        }
        ...
        {
            return beast::detail::empty_base_optimization2 <
