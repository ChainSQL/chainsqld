...
private:
    ...
    // VFALCO TODO hoist to remove template argument dependencies
    class ValueHash
        : private beast::detail::empty_base_optimization2 <Hash>
    ...
    public:
        ...
        ValueHash (Hash const& hash)
            : beast::detail::empty_base_optimization2 <Hash> (hash)
        {
        }
    ...
    // VFALCO TODO hoist to remove template argument dependencies
    class KeyValueEqual
        : private beast::detail::empty_base_optimization2 <KeyEqual>
#ifdef _LIBCPP_VERSION
    ...
    public:
        ...
        KeyValueEqual (KeyEqual const& keyEqual)
            : beast::detail::empty_base_optimization2 <KeyEqual> (keyEqual)
        {
        }
    ...
    class config_t
        ...
        , private beast::detail::empty_base_optimization2 <ElementAllocator>
    {
    public:
        explicit config_t (
            clock_type& clock_)
