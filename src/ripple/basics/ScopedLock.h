...
/**
    ...
    This is the reverse of a std::lock_guard object - instead of locking the
...
public:
    /** Creates a GenericScopedUnlock.
       ...
       operator.
    */
    explicit GenericScopedUnlock(MutexType& lock) noexcept : lock_(lock)
    {
        lock.unlock();
    }
    ...
    GenericScopedUnlock&
    operator=(GenericScopedUnlock const&) = delete;
