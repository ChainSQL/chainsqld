...
SF_U64 const sfDropsPerByte = make::one<SF_U64::type>(&sfDropsPerByte, STI_UINT64, 10, "DropsPerByte");
...
SF_Blob const sfTxsHashFillField = make::one<SF_Blob::type>(&sfTxsHashFillField, STI_VL, 68, "TxsHashFillField");
SF_Blob const sfMicroLedgerSign  = make::one<SF_Blob::type>(&sfMicroLedgerSign,  STI_VL, 69, "MicroLedgerSign");
SF_Blob const sfFinalLedgerSign  = make::one<SF_Blob::type>(&sfFinalLedgerSign,  STI_VL, 70, "FinalLedgerSign");
