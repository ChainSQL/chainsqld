...
bool transResultInfo (TER code, std::string& token, std::string& text)
{
    ...
    results
    {
		...
		{ terTABLE_SAMENAME,         { "terTABLE_SAMENAME",        "Table name and table new name is same or create exist table."                                        } },
		{ terTABLE_NOTEXIST,         { "terTABLE_NOTEXIST",        "Table is not exist." } },
		{ terTABLE_STATEERROR,       { "terTABLE_STATEERROR",      "Table's state is error." } },
		{ terBAD_USER,               { "terBAD_USER",              "BAD User format."    } },
		{ terTABLE_EXISTANDNOTDEL,   { "terTABLE_EXISTANDNOTDEL",  "Table exist and not deleted." } },
		{ terTABLE_STORAGEERROR,     { "terTABLE_STORAGEERROR",    "Table storage error." } },
		{ terTABLE_STORAGENORMALERROR,{ "terTABLE_STORAGENORMALERROR",    "Table storage normal error." } },
		{ terTABLE_TXCHECKERROR,     { "terTABLE_TXCHECKERROR",    "TX is not successive to one table." } },
		{ terTABLE_BASELEDGERERROR,  { "terTABLE_BASELEDGERERROR", "Include multiple operater in one ledger to one table." } },
		{ terTABLE_TXDISPOSEERROR,	 { "terTABLE_TXDISPOSEERROR",	"Tx Dispose error." } },
		{ terTABLE_RULEDISSATISFIED,  { "terTABLE_RULEDISSATISFIED",	"Operation rule not satisfied."}},
		{ terTABLE_TXEERROR,         { "terTABLE_TXEERROR",        "Handle each tx in statements error." } },
		{ terDBNOTCONFIGURED,		 { "terDBNOTCONFIGURED",       "DB is not connected,please checkout 'sync_db'in config file." } },
        { terTABLE_ALREADYDROP,      { "terTABLE_ALREADYDROP",     "Table can not be dorped agagin." } },
        { terUSER_SAMENAME,          { "terUSER_SAMENAME",         "user account and source account is same."                                      } },
