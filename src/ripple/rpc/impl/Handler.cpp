...
Handler const handlerArray[]{
    ...
    {"account_authorized", byRef(&doAccountAuthorized), Role::USER, NO_CONDITION},
    {"contract_tx", byRef(&doContractTxJson), Role::USER, NO_CONDITION},
    ...
    {"ledger_proof", byRef(&doLedgerProof), Role::USER, NO_CONDITION},
    ...
    {"tx_merkle_proof",
     byRef(&doTxMerkleProof),
     Role::USER,
     NEEDS_NETWORK_CONNECTION},
    {"tx_merkle_verify", byRef(&doTxMerkleVerify), Role::USER, NO_CONDITION},
    ...
    // {   "validation_seed",      byRef (&doValidationSeed),     Role::ADMIN,
    // NO_CONDITION  },
    // {   "wallet_seed",          byRef (&doWalletSeed),         Role::ADMIN,
    // NO_CONDITION  },
