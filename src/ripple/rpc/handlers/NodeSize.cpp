...
namespace ripple {
    ...
    Json::Value doNodeSize(RPC::Context& context)
    {
        ...
        context.app.getNodeStore().tune(context.app.config().getSize(siNodeCacheSize), context.app.config().getSize(siNodeCacheAge));
        context.app.getLedgerMaster().tune(context.app.config().getSize(siLedgerSize), context.app.config().getSize(siLedgerAge));
        context.app.family().treecache().setTargetSize(context.app.config().getSize(siTreeCacheSize));
        context.app.family().treecache().setTargetAge(context.app.config().getSize(siTreeCacheAge));
