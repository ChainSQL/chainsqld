...
bool TableDumpItem::DealWithEveryLedgerData(const std::vector<protocol::TMTableData> &aData)
{
    ...
    {     
        ...
        std::string sLedgerHash = to_string(from_hex_text<uint256>(iter->ledgerhash()));
        std::string sLedgerCheckHash = to_string(from_hex_text<uint256>(iter->ledgercheckhash()));
