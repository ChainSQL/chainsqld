...
void Adaptor::share(RCLCxPeerPos const& peerPos)
{
...
void Adaptor::share(RCLCxTx const& tx)
{
...
void Adaptor::share(RCLTxSet const& txns)
{
...
void Adaptor::updateOperatingMode(std::size_t const positions) const
{
