	...
	llvm::JITSymbol findSymbol(std::string const& _name) override
	{
        ...
        auto addr =
            llvm::StringSwitch<uint64_t>(unprefixedName)
				...
				.Case("evm.table_create",reinterpret_cast<uint64_t>(jit.host->table_create))
                .Case("evm.table_rename", reinterpret_cast<uint64_t>(jit.host->table_rename))
                .Case("evm.table_insert", reinterpret_cast<uint64_t>(jit.host->table_insert))
                .Case("evm.table_delete", reinterpret_cast<uint64_t>(jit.host->table_delete))
                .Case("evm.table_drop", reinterpret_cast<uint64_t>(jit.host->table_drop))
                .Case("evm.table_update", reinterpret_cast<uint64_t>(jit.host->table_update))
                .Case("evm.table_grant", reinterpret_cast<uint64_t>(jit.host->table_grant))
