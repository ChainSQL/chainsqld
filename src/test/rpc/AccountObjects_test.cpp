...
public:
    ...
    testErrors()
    {
        ...
        // test errors on marker
        {
            ...
            env(pay(gw, bob, ZXC(1)));
            env(offer(bob, ZXC(100), bob["USD"](1)), txflags(tfPassive));
    ...
    testUnsteppedThenStepped()
    {
        ...
        env(offer(bob, ZXC(100), bob["USD"](1)), txflags(tfPassive));
        env(offer(bob, ZXC(100), USD1(1)), txflags(tfPassive));
    ...
    testObjectTypes()
    {
        ...
        }
        {
            ...
            jvEscrow[jss::Amount] = ZXC(100).value().getJson(JsonOptions::none);
        ...
        }
        {
            ...
            jvPayChan[jss::Amount] =
                ZXC(300).value().getJson(JsonOptions::none);
