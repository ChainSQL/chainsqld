...
public:
    ...
    */
    ...
    /** Returns the ZXC balance on an account.
...
public:
    ...
    /** Create a new account with some ZXC.
        ...
        Effects:
            ...
            The account's ZXC balance is set to amount.

            Generates a test that the balance is set.

        @param amount The amount of ZXC to transfer to
                      each account.
