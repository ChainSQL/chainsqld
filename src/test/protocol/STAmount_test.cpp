...
public:
    ...
    testCustomCurrency()
    {
        ...
        unexpected(
            multiply(STAmount(noIssue(), 20), STAmount(3), zxcIssue())
                    .getText() != "60",
        ...
        unexpected(
            multiply(STAmount(20), STAmount(3), zxcIssue()).getText() != "60",
        ...
        unexpected(
            divide(STAmount(noIssue(), 60), STAmount(3), zxcIssue())
                    .getText() != "20",
        ...
        unexpected(
            divide(STAmount(noIssue(), 60), STAmount(noIssue(), 3), zxcIssue())
                    .getText() != "20",
            "STAmount divide fail");
