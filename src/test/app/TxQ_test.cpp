...
public:
    ...
    void testPreclaimFailures()
    {
        ...
        // Fail in preflight
        env(pay(alice, bob, ZXC(-1000)),
            ter(temBAD_AMOUNT));

        // Fail in preclaim
        env(noop(alice), fee(ZXC(100000)),
            ter(terINSUF_FEE_B));
    }
    ...
    void testInFlightBalance()
    {
        ...
        env(offer(alice, BUX(5000), ZXC(50000)), fee(drops(100)),
            queued);
        ...
        env(offer(alice, BUX(5000), ZXC(50000)), fee(drops(300)),
            queued);
        checkMetrics(env, 1, limit * 2, limit + 1, limit, 256);
        ...
        env(offer(alice, BUX(50), ZXC(500)),
            queued);
        ...
        // (minus the reserve).
        env(pay(alice, charlie, ZXC(50000)),
            queued);
        ...
        env.require(balance(alice, aliceBal - ZXC(500) - drops(20)),
            owners(alice, 0));
        ...
        env.require(balance(alice, aliceBal - ZXC(10000) - drops(20)),
            balance(alice, USD(0)),
        ...
        // So once we close the ledger, alice sent a payment
        // to charlie using only a portion of her ZXC balance
        env.require(balance(alice, aliceBal - ZXC(5000) - drops(20)),
            balance(alice, USD(0)),
