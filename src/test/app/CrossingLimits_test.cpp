...
public:
    ...
    testStepLimit()
    {
        using namespace jtx;
        Env env(*this);
        auto const zxcMax = ZXC(100000000000);
    ...
    testCrossingLimit()
    {
        ...
        n_offers (env, 1000, "bob", ZXC(1), USD(1));

        // Alice offers to buy 1000 ZXC for 1000 USD. She takes the first
        ...
        // Carol offers to buy 1000 ZXC for 1000 USD. She takes the remaining
    ...
    testStepAndCrossingLimit()
    {
        ...
        n_offers (env, 700, "carol", ZXC(1), USD(1));
        n_offers (env, 999, "evita", ZXC(1), USD(1));
        ...
        // Dan offers to buy 900 ZXC for 900 USD. He removes all 100 of Carol's
        // offers as unfunded, then takes 850 USD from Evita's, hitting the
        // crossing limit.
        env(offer("dan", USD(900), ZXC(900)),
            require (
                balance("dan", USD(850)),
                balance("alice", USD(600)), owners("alice", 1),
