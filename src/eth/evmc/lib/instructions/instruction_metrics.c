...
static struct evmc_instruction_metrics istanbul_metrics[256] = {
    ...
    /*                = 0xbe */ {UNDEFINED, 0, 0},
    /*                = 0xbf */ {UNDEFINED, 0, 0},
    /*     CREATETABLE = 0xc0 */{SQLGAS, 5, -4 },
    /*     EXDROPTABLE = 0xc1 */{SQLGAS, 3, -2 },
    /*   EXRENAMETABLE = 0xc2 */{SQLGAS, 5, -4 },
    /*     EXINSERTSQL = 0xc3 */{SQLGAS, 5, -4 },
    /*     EXDELETESQL = 0xc4 */{SQLGAS, 5, -4 },
    /*     EXUPDATESQL = 0xc5 */{SQLGAS, 7, -6 },
    /*     EXSELECTSQL = 0xc6 */{SQLGAS, 5, -4 },
    /*      EXGRANTSQL = 0xc7 */{SQLGAS, 6, -5 },
    /*    EXTRANSBEGIN = 0xc8 */{SQLGAS, 0, 0 },
    /*   EXTRANSCOMMIT = 0xc9 */{SQLGAS, 0, 1 },
    /*    EXGETROWSIZE = 0xca */{SQLGAS, 0, 0 },
    /*    EXGETCOLSIZE = 0xcb */{SQLGAS, 0, 0 },
    /* EXGETVALUEBYKEY = 0xcc */{SQLGAS, 6, -5 },
    /*EXGETVALUEBYINDEX = 0xcd */{SQLGAS, 5, -4 },
    /*      EXEXITFUNC = 0xce */{SQLGAS, 0, 0 },
    /*   EXGETLENBYKEY = 0xcf */{SQLGAS, 4, -3 },
    /* EXGETLENBYINDEX = 0xd0 */{SQLGAS, 3, -2 },
    /*                 = 0xd1 */{UNDEFINED, 0, 0 },
    /*    EXACCOUNTSET = 0xd2 */{TOKENGAS, 3, -2 },
    /*EXTRANSFERFEESET = 0xd3 */{TOKENGAS, 7, -6 },
    /*      EXTRUSTSET = 0xd4 */{TOKENGAS, 6, -5 },
    /*    EXTRUSTLIMIT = 0xd5 */{TOKENGAS, 5, -4 },
    /*EXGATEWAYBALANCE = 0xd6 */{TOKENGAS, 5, -4 },
    /*           EXPAY = 0xd7 */{TOKENGAS, 9, -8 },
    /*                = 0xd8 */ {UNDEFINED, 0, 0},
    /*                = 0xd9 */ {UNDEFINED, 0, 0},
    /*                = 0xda */ {UNDEFINED, 0, 0},
    /*                = 0xdb */ {UNDEFINED, 0, 0},
