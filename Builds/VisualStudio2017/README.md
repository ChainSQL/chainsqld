...
| [OpenSSL Library](README.md#install-openssl) | 1.0.2n或1.1.0+ |
...
### install openssl
> 1. 下载 [Win64 OpenSSL v1.0.2n或v1.1.1版本](http://slproweb.com/products/Win32OpenSSL.html)
...
> cmake -G"Visual Studio 15 2017 Win64" -DCMAKE_BUILD_TYPE=Release E:/work/chainsqld
```
...
> 4. 编译成功后 chainsqld 实例编译至 Build/VisualStudio2017/Debug 目录下，运行 chainsqld 实例前需要将 MYSQL_ROOT_DIR/lib 下的 libmysql.dll 拷贝至此 Debug 目录下
